...
VAR
 ...
 BEGIN
  REPEAT
   ...
   writeln('||=====================================================================================================');
   writeln('||                                                                                                   ||');
   writeln('||  Víctimas del Holocausto                                                                          ||');
   writeln('||                                                                                                   ||');
   writeln('|| * Judíos: Aproximadamente seis millones de judíos fueron asesinados.                              ||');
   writeln('||                                                                                                   ||');
   writeln('|| * Otros Grupos: Los nazis también persiguieron y mataron a otros grupos, incluidos gitanos        ||');
   writeln('||   romaníes), discapacitados, prisioneros de guerra soviéticos, comunistas, socialistas,           ||');
   writeln('||   Testigos de Jehová, y personas LGBTQ+. Se estima que entre 5 y 6 millones de personas           ||');
   writeln('||   de estos grupos también murieron.                                                               ||');
   writeln('||                                                                                                   ||');
   writeln('||---------------------------------------------------------------------------------------------------||');
   writeln('||                                                                                                   ||');
   writeln('|| Resistencia y Rescate                                                                             ||');
   writeln('||                                                                                                   ||');
   writeln('|| * Resistencia Judía: Hubo actos de resistencia, como el Levantamiento del Gueto de Varsovia en    ||');
   writeln('||   1943, donde los residentes del gueto lucharon contra las fuerzas nazis.                         ||');
   writeln('||                                                                                                   ||');
   writeln('|| * Justos entre las Naciones: Algunos individuos no judíos, conocidos como "Justos entre las       ||');
   writeln('||   Naciones", arriesgaron sus vidas para salvar a los judíos. Ejemplos famosos incluyen a Oskar    ||');
   ...
   writeln('||                                                                                                   ||');
   writeln('|| * Juicios de Núremberg: Después de la guerra, los principales líderes nazis fueron juzgados y     ||');
   writeln('||   condenados por crímenes de guerra y crímenes contra la humanidad en los Juicios de              ||');
   writeln('||   Núremberg.                                                                                      ||');
   writeln('||                                                                                                   ||');
   writeln('=======================================================================================================');
   writeln('|/////////////////////////////////////////////////////////////////////////////////////////////////////|');
